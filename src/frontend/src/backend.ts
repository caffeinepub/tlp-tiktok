...
export class Backend implements backendInterface {
    ...
    async createVideo(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob, arg4: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideo(arg0, arg1, arg2, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg3), await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        likes: value.likes,
        thumbnailBlob: await from_candid_ExternalBlob_n17(_uploadFile, _downloadFile, value.thumbnailBlob),
